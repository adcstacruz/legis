...
# i/o directories
df_name = DF_STORE_NAME.format(cid=17) # TODO: change this
df_store_path = BILLS_STORE_PATH
path = INPUT_PATH.format(cid=17) # TODO: change this
...
for textfile in list_files:
    counter += 1
    with open(os.path.join(path,textfile)) as file:
...
print(df)
df.to_pickle(os.path.join(df_store_path, df_name))